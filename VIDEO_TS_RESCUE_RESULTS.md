...
**我们的模型单独，MSE / MAE（VisionTS 列为论文 Table 9 数字）：**

| 数据集 | H | 我们 MSE | 我们 MAE | VisionTS MSE | VisionTS MAE | 我们/VTS |
|---|---:|---:|---:|---:|---:|---:|
| ETTh1 | 96 | 0.386 | 0.403 | 0.353 | 0.383 | 1.09 |
| ETTh1 | 192 | 0.418 | 0.429 | 0.392 | 0.410 | 1.07 |
| ETTh1 | 336 | 0.441 | 0.454 | 0.407 | 0.423 | 1.08 |
| ETTh1 | 720 | 0.477 | 0.481 | 0.406 | 0.441 | 1.17 |
| ETTh2 | 96 | 0.300 | 0.347 | 0.271 | 0.328 | 1.11 |
| ETTh2 | 192 | 0.372 | 0.391 | 0.328 | 0.367 | 1.13 |
| ETTh2 | 336 | 0.413 | 0.421 | 0.345 | 0.381 | 1.20 |
| ETTh2 | 720 | 0.429 | 0.444 | 0.388 | 0.422 | 1.11 |
| ETTm1 | 96 | **0.336** | 0.353 | 0.341 | 0.347 | 0.99 |
| ETTm1 | 192 | 0.379 | 0.377 | 0.360 | 0.360 | 1.05 |
| ETTm1 | 336 | 0.416 | 0.398 | 0.377 | 0.374 | 1.10 |
| ETTm1 | 720 | 0.424 | 0.424 | 0.416 | 0.405 | 1.02 |
| ETTm2 | 96 | **0.172** | **0.253** | 0.228 | 0.282 | 0.75 |
| ETTm2 | 192 | **0.236** | **0.294** | 0.262 | 0.305 | 0.90 |
| ETTm2 | 336 | 0.308 | 0.340 | 0.293 | 0.328 | 1.05 |
| ETTm2 | 720 | 0.371 | 0.389 | 0.343 | 0.370 | 1.08 |
| electricity | 96 | 0.183 | 0.270 | 0.177 | 0.266 | 1.04 |
| electricity | 192 | 0.217 | 0.300 | 0.188 | 0.277 | 1.15 |
| electricity | 336 | 0.259 | 0.336 | 0.207 | 0.296 | 1.25 |
| electricity | 720 | 0.299 | 0.365 | 0.256 | 0.337 | 1.17 |
| weather | 96 | **0.148** | **0.185** | 0.220 | 0.257 | 0.67 |
| weather | 192 | **0.190** | **0.227** | 0.244 | 0.275 | 0.78 |
| weather | 336 | **0.241** | **0.269** | 0.280 | 0.299 | 0.86 |
| weather | 720 | **0.306** | **0.324** | 0.330 | 0.337 | 0.93 |
...
| **我们（视频模型，单独）** | 0.431 | 0.379 | 0.389 | 0.272 | 0.239 | **0.221** | 0.322 |
| **我们 + VisionTS（简单平均）** | **0.383** | 0.336 | **0.349** | **0.256** | ≈0.21（步长 8 估算中） | **0.223** | ≈0.293 |
...
- 尚未完成：electricity 上集成的步长 8 估算（96/336/720）、验证集配方重选（进行中，ETTh1 验证集
  给出与测试集相同的排序）。
