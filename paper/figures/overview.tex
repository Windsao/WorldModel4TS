...
\centering
\begin{tikzpicture}[
  font=\scriptsize, x=0.97cm, y=0.88cm,
...
\node[anchor=west, font=\tiny, text=fcred]  at (0.05,-3.30) {dashed: training path};
\node[anchor=west, font=\tiny, text=pixblue] at (2.10,-3.30) {solid: inference path};
